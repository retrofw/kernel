...
unsigned int OnBeacon(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	//DEBUG FOR UMIDO ONLY
	//char device1[ETH_ALEN] = { 0x00, 0x0e, 0x60, 0x33, 0x5a, 0x42 };
	//char device2[ETH_ALEN] = { 0x00, 0x0e, 0x10, 0x10, 0x92, 0x97 };
	...
	//DEBUG FOR UMIDO ONLY
	/*
	if (_rtw_memcmp(GetAddr3Ptr(pframe), device1, ETH_ALEN) || _rtw_memcmp(GetAddr3Ptr(pframe), device2, ETH_ALEN) )
	{

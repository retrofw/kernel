/*
 * linux/include/asm-mips/mach-jz4750l/jz4750llcdc.h
 *
 * JZ4750L LCDC register definition
 *
 * Copyright (C) 2008-2014 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4750LLCDC_H__
#define __JZ4750LLCDC_H__

...
#ifndef __ASM_JZ4750L_TAURUS_H__
#define __ASM_JZ4750L_TAURUS_H__
...
#define GPIO_SD0_CD_N		GPIO_PC(6)	/* GPC1 */
#define GPIO_SD0_VCC_EN_N       GPIO_PC(18)
#define GPIO_SD0_WP             (32*2+5)

//#define GPIO_SD1_CD_N		GPIO_PC(4)	/* GPC4 */
#define GPIO_SD1_CD_N		GPIO_PC(3)	/* GPC4 */
#define GPIO_SD1_VCC_EN_N       (32*4+4)
...
#define GPIO_DISP_OFF_N         (32*3+24) /*  SDATO */
#define GPIO_LCD_VCC_EN_N       (32*3+22) /*  SDATI */ 
...
#define GPIO_LCD_PWM   		(32*2+15) /* GPC15 PWM5 */
...
#endif /* __ASM_JZ4750L_TAURUS_H__ */

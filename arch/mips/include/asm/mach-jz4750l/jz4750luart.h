/*
 * linux/include/asm-mips/mach-jz4750l/jz4750luart.h
 *
 * JZ4750L UART register definition
 *
 * Copyright (C) 2008-2014 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4750LUART_H__
#define __JZ4750LUART_H__

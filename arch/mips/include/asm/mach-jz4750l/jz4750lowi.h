/*
 * linux/include/asm-mips/mach-jz4750l/jz4750lowi.h
 *
 * JZ4750L OWI register definition
 *
 * Copyright (C) 2008-2014 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4750LOWI_H__
#define __JZ4750LOWI_H__

/*
 * linux/include/asm-mips/mach-jz4750l/jz4750lipu.h
 *
 * JZ4750L IPU register definition
 *
 * Copyright (C) 2008-2014 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4750LIPU_H__
#define __JZ4750LIPU_H__
...
#define write_reg(reg, val)	(*(u32 *)(reg) = (val))

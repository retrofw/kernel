/*
 * linux/include/asm-mips/mach-jz4750l/jz4750lssi.h
 *
 * JZ4750L SSI register definition
 *
 * Copyright (C) 2008-2014 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4750LSSI_H__
#define __JZ4750LSSI_H__
...
#define __ssi_select_ce2(n)	( REG_SSI_CR0(n) |= SSI_CR0_FSEL )
...
#define __ssi_set_frame_length(n, m)					\
	REG_SSI_CR1(n) = (REG_SSI_CR1(n) & ~SSI_CR1_FLEN_MASK) | (((m) - 2) << SSI_CR1_FLEN_BIT)
...
#define __ssi_tx_error_intr(n)		( REG_SSI_CR0(n) & SSI_CR0_TEIE )
#define __ssi_rx_error_intr(n)		( REG_SSI_CR0(n) & SSI_CR0_REIE )

...
static const struct {
	...
	[DMA_ID_PCM0_TX] = {CPHYSADDR(PCM_PDP(0)), DMA_16BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_PMOUT},
	[DMA_ID_PCM0_RX] = {CPHYSADDR(PCM_PDP(0)), DMA_16BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_PMIN},
	[DMA_ID_PCM1_TX] = {CPHYSADDR(PCM_PDP(1)), DMA_16BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_PMOUT},
	[DMA_ID_PCM1_RX] = {CPHYSADDR(PCM_PDP(1)), DMA_16BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_PMIN},
